...
namespace SDProject {
    [Activity(Label = "ReadingActivity", Theme = "@style/AppTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.Orientation | ConfigChanges.ScreenSize | ConfigChanges.SmallestScreenSize | ConfigChanges.ScreenLayout, ScreenOrientation = ScreenOrientation.Portrait)]
    public class ReadingActivity : XActivity {
        ...
        protected override void OnCreate(Bundle savedInstanceState) {
            ...
            postsViewAdapter = new PostsViewAdapter(this);
            contentRecyclerView.SetAdapter(postsViewAdapter);
        ...
        private void Refresh(object sender = null, EventArgs e = null) {
            new Thread(() => {
                try {
                    postsViewAdapter.Items = Server.Blog.GetPosts();
                    RunOnUiThread(() => {
